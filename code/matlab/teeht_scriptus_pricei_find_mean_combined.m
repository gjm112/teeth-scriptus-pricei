...
data=[data_scriptus; data_pricei]
        ...
        save(wd+"/teeth-scriptus-pricei/data/matlab/VV_"+toothtype(t)+"_combined.mat","VV")
        save(wd+"/teeth-scriptus-pricei/data/matlab/PC_feat_"+toothtype(t)+"_combined.mat","PC_feat")
        save(wd+"/teeth-scriptus-pricei/data/matlab/out_beta_"+toothtype(t)+"_combined.mat","out_beta")

csvwrite(wd+"/teeth-scriptus-pricei/data/matlab/VV_"+toothtype(t)+"_combined.csv",VV)
csvwrite(wd+"/teeth-scriptus-pricei/data/matlab/PC_feat_"+toothtype(t)+"_combined.csv",PC_feat)
csvwrite(wd+"/teeth-scriptus-pricei/data/matlab/out_beta_"+toothtype(t)+"_combined.csv",out_beta)
