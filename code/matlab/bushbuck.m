...
save(wd + "/teeth-scriptus-pricei/data/matlab/pairwise_distances_bushbuck.mat","ddd_bushbuck")
  csvwrite(wd + "/teeth-scriptus-pricei/data/matlab/pairwise_distances_bushbuck.csv",ddd_bushbuck)