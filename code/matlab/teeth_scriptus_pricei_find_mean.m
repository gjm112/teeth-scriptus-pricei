...
for t=1:6
    for sp=1:2
        ...
        save(wd +"/teeth-scriptus-pricei/data/matlab/VV_"+toothtype(t)+"_"+species(sp)+".mat","VV")
        save(wd +"/teeth-scriptus-pricei/data/matlab/PC_feat_"+toothtype(t)+"_"+species(sp)+".mat","PC_feat")
        save(wd +"/teeth-scriptus-pricei/data/matlab/out_beta_"+toothtype(t)+"_"+species(sp)+".mat","out_beta")

csvwrite(wd +"/teeth-scriptus-pricei/data/matlab/VV_"+toothtype(t)+"_"+species(sp)+".csv",VV)
csvwrite(wd +"/teeth-scriptus-pricei/data/matlab/PC_feat_"+toothtype(t)+"_"+species(sp)+".csv",PC_feat)
csvwrite(wd +"/teeth-scriptus-pricei/data/matlab/out_beta_"+toothtype(t)+"_"+species(sp)+".csv",out_beta)
