...
load("/Users/nastaranghorbani/Documents/shape/data/teethdata_scriptus_pricei.RData")
...
for (i in c("LM1", "LM2", "LM3", "UM1", "UM2", "UM3")){
  ...
  PC_combined <- read.csv(paste0("/Users/nastaranghorbani/Documents/shape/data/matlab/PC_feat_",i,"_combined.csv"), header = FALSE)
...
for (toothtype in c("LM1","LM2","LM3","UM1","UM2","UM3")){print(toothtype)
  ...
  ddd <- read.csv(paste0("/Users/nastaranghorbani/Documents/shape/data/matlab/pairwise_distances_",toothtype,".csv"), header = FALSE)
  ddd <- as.matrix(ddd)
...
#write.csv(results_table, "/Users/nastaranghorbani/Documents/shape/data/results_table_summary.csv", row.names = FALSE, quote = FALSE)
